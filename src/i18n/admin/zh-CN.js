export const m = {
  ...
  Create_Contest: '创建比赛',
  LLM_Keys: 'LLM 密钥',
  LLM_Gateway_Config: 'LLM Gateway 配置',
  LLM_Gateway_Default_Model: '默认模型',
  LLM_Gateway_API_Key: 'Gateway API 密钥',
  LLM_Gateway_API_Key_Placeholder: '仅在更换密钥时填写',
  LLM_Gateway_API_Key_Current: '当前密钥',
  LLM_Key_Create: '创建 LLM 密钥',
  LLM_Key_List: 'LLM 密钥列表',
  LLM_Key_Prefix: '密钥前缀',
  LLM_Key_One_Time: '原始密钥只显示一次，请立即妥善保存。',
  LLM_Model_Scope: '模型范围',
  LLM_Model_Scope_Placeholder: '逗号分隔，例如：gpt-oss-20b,*',
  LLM_Name: '名称',
  LLM_Status: '状态',
  LLM_Create: '创建',
  LLM_Total_Requests: '总请求数',
  LLM_Total_Prompt_Tokens: '总提示词Token',
  LLM_Name_Required: '请输入密钥名称。',
  LLM_Route_Create: '创建 LLM 路由',
  ...
  LLM_Enabled_On: '开启',
  LLM_Enabled_Off: '关闭',
  LLM_Model_Name_Required: '请输入模型名称。',
  LLM_Upstream_Required: '请输入上游 URL。',
  Revoke: '吊销',
  // User.vue
  User_User: '用户',
  Import_User: '导入用户',
