export const m = {
  ...
  Create_Contest: '建立比賽',
  LLM_Keys: 'LLM 金鑰',
  LLM_Gateway_Config: 'LLM Gateway 設定',
  LLM_Gateway_Default_Model: '預設模型',
  LLM_Gateway_API_Key: 'Gateway API 金鑰',
  LLM_Gateway_API_Key_Placeholder: '僅在更換金鑰時填寫',
  LLM_Gateway_API_Key_Current: '目前金鑰',
