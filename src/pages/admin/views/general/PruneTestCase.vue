  ...
  <div>
    <panel>
      ...
      <el-table :data="data">
        ...
        <el-table-column
          :label="$t('m.PruneTestCase_Options')"
          fixed="right"
          width="200">
          <template slot-scope="{row}">
            <icon-btn :name="$t('m.PruneTestCase_Delete')" icon="trash" @click.native="deleteTestCase(row.id)"></icon-btn>
          </template>
        </el-table-column>
      </el-table>
